      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 text-gray-700">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">4 School Lane, Kokstad, 4700</p>
                    <p className="text-sm text-gray-500">Harry Gwala District, KwaZulu-Natal</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-gray-700">
                  <MapPin className="shrink-0 mt-0.5 text-school-blue" size={20} />
                  <div>
                    ...
                    <p className="text-sm text-gray-500">P.O. Box 110, Kokstad, 4700</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-gray-700">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">039 727 3662</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-gray-700">
                  ...
                  <div>
                    ...
                    <a href="mailto:mcsss@telkomsa.net" className="text-sm text-school-blue hover:underline">mcsss@telkomsa.net</a>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-gray-700">
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100 min-h-[400px]">
            <iframe
              title="Mount Currie SSS Location"
