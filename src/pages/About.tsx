  ...
  return (
    <div className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="section-title">About Mount Currie SSS</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mb-16 sm:mb-24">
          ...
          >
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed text-base">
              <p>Mount Currie Senior Secondary School is a public secondary school located at the foot of the magnificent Mount Currie mountain in Kokstad, KwaZulu-Natal. Our school takes its name from the very mountain that gave Kokstad its identity — named after Sir Walter Currie, champion of the Griqua people who founded this historic town.</p>
              <p>As a Section 21 school, we manage our own finances allocated by the Department of Education, ensuring accountability and quality delivery of education to every learner. We offer ordinary curriculum subjects across Grades 8–12, preparing our learners for the National Senior Certificate.</p>
              <p>Under the leadership of Principal Mr. Solomon, the school serves 921 learners with a dedicated team of 33 educators, committed to excellence and the holistic development of every student in the Harry Gwala District.</p>
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3">
              ...
              <div className="col-span-2 flex flex-col justify-center p-8 md:p-12">
                ...
                <div className="space-y-4 text-gray-700 text-base sm:text-lg leading-relaxed">
                  <p>At Mount Currie Senior Secondary School, we are committed to providing a safe, inclusive and stimulating environment that enables every learner to reach their full potential through quality teaching, strong values and community partnership.</p>
                  <p>We are proud of our learners who achieved a 72.6% matric pass rate — an improvement from 63.2% the previous year. This reflects the dedication of both our staff and our learners in striving for excellence in all we do.</p>
                  <p>Nestled in the heart of Kokstad, in the shadow of the majestic Mount Currie mountain range, we invite families and learners to join us in this journey of growth, learning, and achievement.</p>
                </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { label: 'School Type', value: 'Quintile 4 (Section 21)' },
              { label: 'Grades', value: 'Grade 8 – 12' },
              { label: 'Location', value: 'Kokstad, KwaZulu-Natal' },
              { label: 'EMIS Number', value: '500215340' },
            ].map((fact, i) => (
