    ...
    <footer className="bg-school-blue text-white pt-12 pb-8 w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/80 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>4 School Lane, Kokstad, 4700, KwaZulu-Natal</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={16} className="shrink-0" />
                <span>039 727 3662</span>
              </li>
              <li className="flex items-center gap-2">
                <Mail size={16} className="shrink-0" />
                <a href="mailto:mcsss@telkomsa.net" className="hover:text-white">mcsss@telkomsa.net</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-6 text-center text-white/60 text-xs">
          <p>&copy; {new Date().getFullYear()} Mount Currie Senior Secondary School. All Rights Reserved.</p>
          <p className="mt-1 text-white/40">Kokstad, Harry Gwala District, KwaZulu-Natal &middot; Quintile 4 &middot; Section 21 Public School &middot; EMIS: 500215340</p>
